...
<h4 className={styles.dementiaHeading}>DEMENTIA, WE HAVE YOU OUTNUMBERED!</h4>
        <div className={styles.iconBox}>
            <div className={styles.iconBoxOneImage}><img src="/assets/img/4dementia_icon_peoplegreen.png" />
                <br />DEMENTIA
            </div>
        ...
        <div className={styles.iconBoxTwo}>
            <div className={styles.iconBoxTwoImage}><img src="/assets/img/4dementia_icon_peoplebrown.png" />
                <br />PARKRUN
            </div>
...
<div className={styles.iconsContainerTwo}>
        <div className={styles.iconBox}><div className={styles.iconBoxOneImage}><img src="/assets/img/4dementia_icon_parkrun.png" /></div></div>
        <div className={styles.iconBox}><div className={styles.iconBoxTwoImage}><img src="/assets/img/4dementia_icon_aruk.png" /></div></div>
